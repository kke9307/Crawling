...
<div class="content-area"><!-- 우측 본문영역 -->
	<div class="breadcrumbs"><span class="home">HOME</span> &gt; 배너/팝업 &gt; <strong>메인 중간 배너 등록</strong></div>
	<h2>메인 중간  배너 등록</h2>
    ...
    <input type="hidden" name="bt_position" id="bt_position" value="M" />
			...
			<tbody>
				<tr>
					...
					<td colspan="3">
							...
							(이미지사이즈 : 2500 * 295 / 파일 형식 : jpg,jpge,png / 파일용량 : 3M 이하)
					</td>
				</tr>
				<tr>
	...
	<div class="btn-area">
		...
		<a href="<spring:message code="admin.context" />/banner/banner_bottom_list.do" class="button big"><span>목록</span></a>
	</div>
</div><!-- //우측 본문영역 -->