	...
	if(data.result == 'success'){
		...
		$("#frm").submit();
			...
			<div class="content-area"><!-- 우측 본문영역 -->
				<div class="breadcrumbs"><span class="home">HOME</span> &gt; 배너/팝업 &gt; <strong>메인상단 배너관리</strong></div>
				<h2>메인상단 배너관리</h2>
            	<form name="frm" id="frm" method="post" action="<spring:message code="admin.context" />/banner/banner_list.do">
				...
				<div class="grid-area"><!-- 목록 -->
					...
					<div class="btn-area right">
						...
						<a href="<spring:message code="admin.context" />/banner/banner_inscr.do" class="button"><span>신규등록</span></a>
					</div>
							...
							<c:set var="lno">${lno + 1}</c:set>
								<tr>
									<td><input type="checkbox" name="del_id" id="del_id_${item.bt_idx}" value="${item.bt_idx}"></td>
   								    ...
   								    <td class="left">
   								    	<a href="./banner_upscr.do?bt_idx=${item.bt_idx}&amp;${StrParam}">
   								    		${item.bt_name}
   								    	</a>
   								    </td>
   								    <td>
