...
<div class="content-area"><!-- 우측 본문영역 -->
	<div class="breadcrumbs"><span class="home">HOME</span> &gt; 배너/팝업 &gt; <strong>스폰서 배너 등록</strong></div>
	<h2>스폰서 배너 등록</h2>
    ...
    <input type="hidden" name="bt_position" id="bt_position" value="S" />
	...
	<div class="btn-area">
		...
		<a href="<spring:message code="admin.context" />/banner/banner_sponser_list.do" class="button big"><span>목록</span></a>
	</div>
</div><!-- //우측 본문영역 -->